...
public class ParentMenuEditorFrame extends JFrame {
     ...
     *	Default constructor
     */
    public ParentMenuEditorFrame( WebCatalogService service ) {
        super();
        ...
        htmlTextArea.setText( service.getParentMenuHtml() );
    }
    ...
    private void finishedAction ( ActionEvent evt ) {
        ...
        service.saveParentMenuHtml( htmlTextArea.getText() );
